...
@Component({
    ...
    providers: [
        NestedOptionHost,
        {
           ...
           useExisting: DxiChatButtonComponent,
        }
    ]
})
export class DxiChatButtonComponent extends CollectionNestedOption {
    @Input()
...
@NgModule({
  imports: [
    DxiChatButtonComponent
  ],
  exports: [
    DxiChatButtonComponent
  ],
})
export class DxiChatButtonModule { }
