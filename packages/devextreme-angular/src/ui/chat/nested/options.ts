...
@Component({
    selector: 'dxo-chat-options',
    template: '<ng-content></ng-content>',
    styles: [':host { display: block; }'],
    imports: [ DxIntegrationModule ],
    providers: [NestedOptionHost, DxTemplateHost]
})
export class DxoChatOptionsComponent extends NestedOption implements AfterViewInit, OnDestroy, OnInit,
    IDxTemplateHost {
    @Input()
...
@NgModule({
  imports: [
    DxoChatOptionsComponent
  ],
  exports: [
    DxoChatOptionsComponent
  ],
})
export class DxoChatOptionsModule { }
