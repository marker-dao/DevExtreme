...
export class DxChatComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
    ...
    @Input()
    get fileUploaderOptions(): { dialogTrigger?: any | string | undefined, showFileList?: boolean, uploadMode?: FileUploadMode, value?: Array<any> } {
        return this._getOption('fileUploaderOptions');
    }
    set fileUploaderOptions(value: { dialogTrigger?: any | string | undefined, showFileList?: boolean, uploadMode?: FileUploadMode, value?: Array<any> }) {
     ...
     */
    @Output() fileUploaderOptionsChange: EventEmitter<{ dialogTrigger?: any | string | undefined, showFileList?: boolean, uploadMode?: FileUploadMode, value?: Array<any> }>;
